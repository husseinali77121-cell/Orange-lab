...
<style>
  ...
  .hero::before {
    ...
    background: radial-gradient(circle at 70% 50%, rgba(255,107,0,0.18) 0%, transparent 70%);
  }
  .logo-ring {
  ...
  .hero-title {
    font-size: 34px; font-weight: 900; color: #FF6B00;
    margin: 0 0 4px; line-height: 1.1; position: relative; z-index: 1;
    text-shadow: 0 2px 20px rgba(255,107,0,0.4);
  }
  .hero-sub {
  ...
  .cta-call {
    background: transparent; color: #FF6B00 !important;
    padding: 14px 28px; border-radius: 50px;
    font-size: 15px; font-weight: 800;
    text-decoration: none; display: inline-flex; align-items: center; gap: 8px;
  ...
  .loc-link {
    display: block; background: #FF6B00;
